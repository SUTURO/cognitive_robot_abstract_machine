...
def main():
    ...
    if (
        ...
        or str(person1.hri_favourite_drink[0]) == "typing.Optional[str]"
    ):
    ...
    talking.pub(
        f"Hello {person1.name}, I also like to drink {person1.hri_favourite_drink[0]}, especially after a nice round of hobby horsing! What is your hobby?"
    )
