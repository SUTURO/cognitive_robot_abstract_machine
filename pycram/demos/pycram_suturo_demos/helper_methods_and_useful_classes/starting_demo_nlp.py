    ...
    try:
        while True:
            ...
            try:
                ...
                cleanup = subprocess.Popen('bash -i -c "nlp_cleanup"', shell=True)
                cleanup.wait(100)
                ...
                sleep(
                    3
                )  # Give processes some buffer time - needed, otherwise doesn't work sometimes
            ...
            try:
                ...
                match nlp.filter_response(nlp.last_output, ""):
                    ...
                    case "GPSR":
                        proc = subprocess.Popen(
                            'bash -i -c "nlp_rasa_gpsr_start"', shell=True
                        )
                    case "Restaurant":
                        proc = subprocess.Popen(
                ...
                match nlp.filter_response(nlp.last_output, ""):
                    ...
                    case "Receptionist":
                        print("Insert Receptionist code here.......")
                    case "GPSR" | "GPS" | "GPS R":
