...
chd: Node | None = None
current_human_position: Pose | None = None
is_init = False
...
@init_robokudo_interface
def query_postion_closest_object() -> Pose:
    result = send_query()
    posi = None
    if result is None:
        return None
...
def query_waving_human() -> Optional[Pose]:
    ...
    try:
        ...
        return None
    return Pose.from_ros_message(ros_pose_stamped)
