...
class GraspBar(Task):
    """
    Like CartesianPose but with more freedom along the bar axis.
    Aligns tip_grasp_axis with bar_axis and allows tip to be anywhere within bar_length of bar_center.
    """
